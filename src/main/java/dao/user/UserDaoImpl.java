...
////					"userRole,gender,birthday,phone,address,creationDate,createdBy,picPath,headImg) " +
////					"values(?,?,?,?,?,?,?,?,?,?,?,?)";
////			Object[] params = {user.getUserCode(),user.getUserName(),user.getUserPassword(),
////							user.getUserRole(),user.getGender(),user.getBirthday(),
////							user.getPhone(),user.getAddress(),user.getCreationDate(),user.getCreatedBy(),user.getPicPath(),user.getHeadImg()};
