 ...
 <div class="right">
        ...
        <div class="providerView">
            ...
            <p><strong>用户头像：</strong>
                <c:if test="${user.headImg == null }"><span>还未上传！</span></c:if>
                <c:if test="${user.headImg != null }"><img src="/statics/uploadFile/${user.headImg}" width="150px"/></c:if>
            </p>
            <p><strong>用户证件照：</strong>
                <c:if test="${user.picPath == null }"><span>还未上传！</span></c:if>
                <c:if test="${user.picPath != null }"><img src="/statics/uploadFile/${user.picPath}" width="300px"/></c:if>
            </p>
